...
class Themes {
  final lightTheme = ThemeData.light().copyWith(
    ...
    colorScheme: ColorScheme.fromSwatch().copyWith(primary:LightColor.primary, secondary: LightColor.primary),
  );
  final darkTheme = ThemeData.dark().copyWith(
    ...
    colorScheme: ColorScheme.fromSwatch().copyWith(primary:LightColor.primary,secondary: LightColor.primaryDark),
  );
